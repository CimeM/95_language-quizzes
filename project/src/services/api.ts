...
import { API_URL, ThemeQuiz, UserProgress } from '../types';
...
export const fetchWeeklyQuizzes = async () : Promise<ThemeQuiz[]> =>{
  return [
    {
      id: 'grocery-basics',
...
export const fetchDailyChallenge = async () : Promise<ThemeQuiz> =>{
  return {
    id: 'daily-challenge',
    theme: 'daily',
    medal: 'none',
